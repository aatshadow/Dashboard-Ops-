...
const VALID_COLUMNS = {
  ...
  crm_contacts: new Set(['client_id', 'name', 'email', 'phone', 'company', 'position', 'instagram', 'country', 'source', 'status', 'assigned_to', 'assigned_closer', 'assigned_setter', 'assigned_cold_caller', 'tags', 'custom_fields', 'notes', 'deal_value', 'last_activity_at', 'updated_at', 'address', 'whatsapp', 'zoom_link', 'website', 'linkedin', 'pipeline_id']),
