...
export default function AgentChat() {
  ...
  const greeting = buildGreeting(clientName)
  ...
  useEffect(() => {
    setMessages([{ role: 'assistant', content: buildGreeting(clientName) }])
  }, [clientName])
  ...
  async function sendQuestion(question) {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/agent`, {
        ...
        body: JSON.stringify({ question: question.trim(), history, clientSlug }),
      })
          ...
          <div className="agent-header">
            <div className="agent-header-info">
              ...
              <div>
                ...
                <div className="agent-header-sub">Datos de {clientName}</div>
              </div>
            </div>
